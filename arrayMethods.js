...
/*
  Use a higher order method to get all the order totals 
  after adding in the sales tax (given to you as a tax rate, hint: you'll need to do some multiplication).
   Your answer should be an array of numbers, one total for each order.
*/

const myNewOrders = orders.map(function(elem) {
  return elem.price + (elem.price * elem.tax)
})
console.log(myNewOrders)
...
}, 0)  //I don't understand why it would need an initial value.
